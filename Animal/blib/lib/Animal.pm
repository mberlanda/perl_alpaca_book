...
Perhaps a little code snippet.
    ...
    use Animal;
    my $foo = Animal->named("blahblah");
    ...

=head1 SUBROUTINES/METHODS

=head2 named
This method is a constructor for the Animal object

=head2 name
This method is a getter

=head2 set_name
This method is a setter for instance only
...
=head2 sound
This method is available only for Animal sublclasses

=head2 speak
This method cannot take arguments for Animal's subclasses
